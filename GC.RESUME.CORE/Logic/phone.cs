...
namespace GC.RESUME.CORE.Logic
{
    class phone
    {
        public async Task<Contracts.phone> FindAsync(Guid entityId)
        {
            ...
            var entity = await context.Phones.FirstOrDefaultAsync(p => p.Id == entityId);
            ...
            var contract = entity.ConvertTo<Contracts.phone, DAL.Entities.Phone>();
